...
export default function AgregarProducto() {
  ...
  const handleSubmit = async (event) => {
    event.preventDefault();
    await axios.post(`${API_URL}/api/cliente/create`, inputCliente).then(
      (response) => {
                        ...
                        <div className="">
                          <table className="table-auto">
                            <tbody>
                              ...
                              <tr>
                                <td className="text-sm">Dirección</td>
                                <td>
                                  <input
                                    type="text"
                                    name="direccion"
                              ...
                              <tr>
                                <td className="text-sm">Teléfono</td>
                                <td>
                                  <input
                                    type="text"
                                    name="telefono"
                              ...
                              <tr>
                                <td className="text-sm">Comuna</td>
                                <td>
                                  <input
                                    type="text"
                                    name="comuna"
                              ...
                              <tr>
                                <td className="text-sm">Región</td>
                                <td>
                                  <input
                                    type="text"
                                    name="region"
