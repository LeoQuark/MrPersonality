...
export default function AgregarVentas(props) {
  ...
  const handleSubmit = async (event) => {
    event.preventDefault();
    await axios.post(`${API_URL}/api/venta/create`).then(
      (response) => {
        if (response.status === 200) {
          setOpen(false);
          history.push(`/admin/clientes/${user.user.id_admin}`);
        }
      },
      (error) => {
        console.log(error);
                      ...
                      <div className="text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <div className="">
                          <table className="table-auto">
                            <tbody>
                              <tr>
                                <td className="text-sm left">Cantidad</td>
                                <td>
                                  <input
                                    type="number"
                                    name="cantidad"
                              ...
                              <tr>
                                <td className="text-sm left">Fecha</td>
                                <td>
                                  <input
                                    type="date"
                                    name="fecha"
                              ...
                              <tr>
                                <td className="text-sm">Entregado</td>
                                <td>
                                  <input
                                    type="text"
                                    name="entregado"
                              ...
                              <tr>
                                <td className="text-sm">ID Producto</td>
                                <td>
                                  <input
                                    type="number"
                                    name="id_producto"
                              ...
                              <tr>
                                <td className="text-sm">Tipo de Compra</td>
                                <td>
                                  <input
                                    type="text"
                                    name="tipo_compra"
                              ...
                              <tr>
                                <td className="text-sm">Tipo de Pago</td>
                                <td>
                                  <input
                                    type="text"
                                    name="tipo_pago"
                              ...
                              <tr>
                                <td className="text-sm">id_cliente</td>
                                <td>
                                  <input
                                    type="number"
                                    name="id_cliente"
